...
if sys.version_info[:3] < (2, 7, 0):
    sys.exit("Error: Sperocoin Electrum requires Python version >= 2.7.0...")
...
if not os.access(appdata_dir, os.W_OK):
    appdata_dir = os.path.join(usr_share, "sperocoin-electrum")
...
setup(
    ...
    scripts=['sperocoin-electrum'],
    include_package_data=True,
    data_files=data_files,
    description="Sperocoin Electrum wallets for desktop",
    author="Thomas Voegtlin, Larry Ren, SperoCoin Developers",
    author_email="thomasv1@gmx.de, ren@sperocoin.com, helper@sperocoin.org",
    maintainer="SperoCoin Developers",
    maintainer_email="helper@sperocoin.org",
    license="GNU GPLv3",
    url="https://sperocoin.org",
    download_url="https://pypi.python.org/packages/source/l/sperocoin-electrum/sperocoin-electrum-%s.tar.gz" % VERSION,
