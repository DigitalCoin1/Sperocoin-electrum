...
sperocoin = lambda v: v * 100000000
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        # Sperocoin address code
        self.address_input = QLineEdit()
        self.address_input.setPlaceholderText(_("Enter a Sperocoin address or contact"))
        ...
        self.setWindowTitle("Sperocoin Electrum")
    ...
    def set_balances(self, btc_balance):
        """Set the sperocoin balance and update the amount label accordingly."""
        ...
        self.setWindowTitle("Sperocoin Electrum %s - %s %s" % (electrum_version, amount, unit))

    def amount_input_changed(self, amount_text):
        """Update the number of sperocoins displayed."""
    ...
    def check_button_status(self):
        """Check that the sperocoin address is valid and that something
    ...
    def the_website(self):
        webbrowser.open("https://sperocoin.org")
...
class BalanceLabel(QLabel):
    ...
    def set_balance_text(self, amount, unit, quote_text):
        """Set the amount of sperocoins in the gui."""
        if self.state == self.SHOW_CONNECTING:
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Sperocoin address to the clipboard!"))
        ...
        self.setWindowTitle("Sperocoin Electrum - " + _("Receive Sperocoin payment"))
...
class MiniActuator:
    ...
    def set_configured_currency(self, set_quote_currency):
        ...
        # currency can be none when Sperocoin Electrum is used for the first
    ...
    def waiting_dialog(self, f):
        ...
        w = QDialog()
        w.resize(200, 70)
        w.setWindowTitle('Sperocoin Electrum')
    ...
    def send(self, address, amount, parent_window):
        """Send sperocoins to the target address."""
