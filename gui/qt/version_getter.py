...
class UpdateLabel(QLabel):
    ...
    def mouseReleaseEvent(self, event):
        dialog = QDialog(self)
        dialog.setWindowTitle(_('Sperocoin Electrum update'))
        dialog.setModal(1)

        main_layout = QGridLayout()
        main_layout.addWidget(QLabel(_("A new version of Sperocoin Electrum is available:")+" " + self.latest_version), 0,0,1,3)
