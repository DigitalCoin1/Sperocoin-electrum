#!/usr/bin/env python
#
# Electrum - lightweight Sperocoin client
...
from .amountedit import AmountEdit, SPEROAmountEdit, MyLineEdit
...
class ElectrumWindow(QMainWindow):
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Sperocoin Electrum ' + self.wallet.electrum_version + '  -  ' + self.wallet.storage.path
    ...
    def backup_wallet(self):
        ...
        if new_path != path:
            try:
                ...
                QMessageBox.critical(None,"Unable to create backup", _("Sperocoin Electrum was unable to copy your wallet file to the specified location.")+"\n" + str(reason))
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("https://sperocoin.org"))
        help_menu.addSeparator()
        help_menu.addAction(_("&Documentation"), lambda: webbrowser.open("https://sperocoin.org/documentation.html")).setShortcut(QKeySequence.HelpContents)
    ...
    def show_about(self):
        QMessageBox.about(self, "Sperocoin Electrum",
            _("Version")+" %s" % (self.wallet.electrum_version) + "\n\n" + _("Sperocoin Electrum's focus is speed, with low resource usage and simplifying Sperocoin. You do not need to perform regular backups, because your wallet can be recovered from a secret phrase that you can memorize or write on paper. Startup times are instant because it operates in conjunction with high-performance servers that handle the most complicated parts of the Sperocoin system."))

    def show_report_bug(self):
        QMessageBox.information(self, "Sperocoin Electrum - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/DigitalCoin1/Sperocoin-electrum/issues\">https://github.com/DigitalCoin1/Sperocoin-electrum/issues</a>")
    ...
    def create_history_menu(self, position):
        ...
        be = self.config.get('block_explorer', 'https://explorer.sperocoin.org')
        if be == 'https://explorer.sperocoin.org':
            block_explorer = 'http://https://explorer.sperocoin.org/tx/'
    ...
    def create_receive_tab(self):
        ...
        self.receive_amount_e = SPEROAmountEdit()
    ...
    def update_receive_qr(self):
        ...
        if addr:
            ...
            p = urlparse.ParseResult(scheme='sperocoin', netloc='', path=addr, params='', query='&'.join(query), fragment='')
    ...
    def read_send_tab(self):
        ...
        for type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('Sperocoin Address is None'), _('OK'))
                return
            if type == 'op_return':
                continue
            if type == 'address' and not bitcoin.is_address(addr):
                QMessageBox.warning(self, _('Error'), _('Invalid Sperocoin Address'), _('OK'))
                return
            if amount is None:
    ...
    def pay_from_URI(self,URI):
        ...
        try:
            ...
            QMessageBox.warning(self, _('Error'), _('Invalid sperocoin URI:') + '\n' + str(e), _('OK'))
            return
    ...
    def create_contact_menu(self, position):
        ...
        if not item:
            ...
            menu.addAction(_("QR code"), lambda: self.show_qrcode("sperocoin:" + addr, _("Address")))
            if is_editable:
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive sperocoins.") + " " \
    ...
    def tx_from_text(self, txt):
        ...
        if is_hex:
            try:
                ...
                traceback.print_exc(file=sys.stdout)
                QMessageBox.critical(None, _("Unable to parse transaction"), _("Sperocoin Electrum was unable to parse your transaction"))
                return
    ...
    def read_tx_from_file(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to read file or no transaction found"), _("Sperocoin Electrum was unable to open your transaction file") + "\n" + str(reason))
    ...
    def export_privkeys_dialog(self, password):
        ...
        try:
            ...
            export_error_label = _("Sperocoin Electrum was unable to produce a private key-export.")
    ...
    def do_import_labels(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to import labels"), _("Sperocoin Electrum was unable to import your labels.")+"\n" + str(reason))
    ...
    def do_export_labels(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to export labels"), _("Sperocoin Electrum was unable to export your labels.")+"\n" + str(reason))
    ...
    def export_history_dialog(self):
        ...
        try:
            ...
            export_error_label = _("Sperocoin Electrum was unable to produce a transaction export.")
    ...
    def settings_dialog(self):
        ...
        d = QDialog(self)
        d.setWindowTitle(_('Sperocoin Electrum Settings'))
        d.setModal(1)
        vbox = QVBoxLayout()
        grid = QGridLayout()
        ...
        block_explorers = ['https://explorer.sperocoin.org']
        block_ex_label = QLabel(_('Online Block Explorer') + ':')
        block_ex_combo = QComboBox()
        block_ex_combo.addItems(block_explorers)
        block_ex_combo.setCurrentIndex(block_explorers.index(self.config.get('block_explorer', 'https://explorer.sperocoin.org')))
        ...
        if self.need_restart:
            QMessageBox.warning(self, _('Success'), _('Please restart Sperocoin Electrum to activate the new GUI settings'), _('OK'))
    ...
    def plugins_dialog(self):
        ...
        d.setWindowTitle(_('Sperocoin Electrum Plugins'))
        d.setModal(1)
