    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Sperocoin Electrum"
...
def pay_to(recipient, amount, fee, label):
    ...
    droid.dialogCreateSpinnerProgress("Sperocoin Electrum", "signing transaction...")
    droid.dialogShow()
        ...
        if event["name"]=="click":
            ...
            if out == 'contacts':
                ...
                if receive_addr:
                    ...
                    if amount:
                        receive_addr = 'sperocoin:%s?amount=%s'%(receive_addr, amount)
        ...
        if event["name"] == "click":
            ...
            if id=="buttonPay":
                ...
                if not is_valid(recipient):
                    modal_dialog('Error','Invalid Sperocoin address')
                    continue
...
class ElectrumGui:
    ...
    def restore_wallet(self):
        ...
        droid.dialogCreateSpinnerProgress("Sperocoin Electrum", msg)
        droid.dialogShow()
