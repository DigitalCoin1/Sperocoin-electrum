...
def user_dir():
    if "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Sperocoin-Electrum")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Sperocoin-Electrum")
    elif "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".sperocoin-electrum")
